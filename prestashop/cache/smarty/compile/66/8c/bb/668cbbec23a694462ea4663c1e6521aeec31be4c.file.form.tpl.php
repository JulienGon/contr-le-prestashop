<?php /* Smarty version Smarty-3.1.19, created on 2016-04-11 11:51:13
         compiled from "/Applications/MAMP/htdocs/prestashop_1.6.1.4_fr/prestashop/admin281z9vbni/themes/default/template/controllers/groups/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1660011713570b7391be7557-95036712%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '668cbbec23a694462ea4663c1e6521aeec31be4c' => 
    array (
      0 => '/Applications/MAMP/htdocs/prestashop_1.6.1.4_fr/prestashop/admin281z9vbni/themes/default/template/controllers/groups/helpers/form/form.tpl',
      1 => 1452091828,
      2 => 'file',
    ),
    '709d738b5bcbbe21a74a2309cde24b59a007a7f8' => 
    array (
      0 => '/Applications/MAMP/htdocs/prestashop_1.6.1.4_fr/prestashop/admin281z9vbni/themes/default/template/helpers/form/form.tpl',
      1 => 1452091828,
      2 => 'file',
    ),
    '31b70d07be8825501af15a26f8fa694c3b5f0449' => 
    array (
      0 => '/Applications/MAMP/htdocs/prestashop_1.6.1.4_fr/prestashop/admin281z9vbni/themes/default/template/helpers/form/form_group.tpl',
      1 => 1452091828,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1660011713570b7391be7557-95036712',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_570b7392603da5_49200909',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_570b7392603da5_49200909')) {function content_570b7392603da5_49200909($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/Applications/MAMP/htdocs/prestashop_1.6.1.4_fr/prestashop/tools/smarty/plugins/function.counter.php';
?>
...
" />
	...
	<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='modules') {?>
		<div <?php if (!$_smarty_tpl->tpl_vars['form_id']->value) {?>class="hide"<?php }?>>
			<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Authorized modules:'),$_smarty_tpl);?>
</label>
		</div>
...
' + ' ' + jsonData.discount+'<?php echo smartyTranslate(array('s'=>'%'),$_smarty_tpl);?>
</td><td><a href="#" onclick="deleteCategoryReduction('+jsonData.id_category+');" class="btn btn-default"><i class="icon-trash"></i> <?php echo smartyTranslate(array('s'=>'Delete'),$_smarty_tpl);?>
</a></td></tr>');
		...
		<div class="col-lg-9">
			<a class="btn btn-default" href="#group_discount_category_fancybox" id="group_discount_category"><?php echo smartyTranslate(array('s'=>'Add a category discount'),$_smarty_tpl);?>
</a>
...
">
		...
		<div id="group_discount_category_fancybox" class="bootstrap" style="display:none" >
			<div class="panel">
				<div class="panel-heading">
					<i class="icon-group"></i> <?php echo smartyTranslate(array('s'=>'New group category discount'),$_smarty_tpl);?>

				</div>
				<?php echo $_smarty_tpl->tpl_vars['categoryTreeView']->value;?>

				<div class="form-horizontal">
				<div class="alert alert-info"><?php echo smartyTranslate(array('s'=>'Caution: The discount applied to a category does not stack with the overall reduction but instead replaces it.'),$_smarty_tpl);?>
</div>
				<div class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'Only products that have this category as the default category will be affected.'),$_smarty_tpl);?>
</div>
				<div class="form-group">
					<label class="control-label col-lg-3" for="category_reduction_fancybox"><?php echo smartyTranslate(array('s'=>'Discount (%):'),$_smarty_tpl);?>
</label>
					<div class="col-lg-9">
				...
				<div class="form-group">
					<div class="col-lg-12">
						<button type="button" onclick="addCategoryReduction();" class="btn btn-default pull-right"><?php echo smartyTranslate(array('s'=>'add'),$_smarty_tpl);?>
</button>
					</div>
				</div>
			</div>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '1660011713570b7391be7557-95036712');
content_570b7392393417_84368282($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2016-04-11 11:51:14
         compiled from "/Applications/MAMP/htdocs/prestashop_1.6.1.4_fr/prestashop/admin281z9vbni/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_570b7392393417_84368282')) {function content_570b7392393417_84368282($_smarty_tpl) {?>
